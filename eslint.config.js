...
export default ts.config(
	...
	},
	{
		 ...
		 *
		 * Виняток файловий, а не глобальний, навмисно: у решті 76 компонентів новий
		 * {@html} тепер валить збірку.
		 */
		files: [
			'src/lib/components/sea/TopControls.svelte',
			'src/lib/components/sections/PortfolioTabs.svelte',
			'src/lib/components/sections/pages/PromoPage.svelte',
			'src/lib/components/ui/ContactButton.svelte',
