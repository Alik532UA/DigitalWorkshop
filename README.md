...
Про переїзд на власний домен — [CUSTOM-DOMAIN-v8.md](../sveltekit-canon/selection_criteria/v8/ops/CUSTOM-DOMAIN-v8.md): міняти `base` наосліп не можна, там зібрані граблі двох уже наявних переїздів.
