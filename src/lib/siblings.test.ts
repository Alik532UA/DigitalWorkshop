 ...
 * adoptananimal. Усі вони будують адресу з рядка `digitalworkshop`: сорок одна
 * мова, українська на голій адресі, решта сегментом. Розходження тут ламає
...
describe('рядок цього сайту в таблиці сусідів', () => {
	it('перелічує ті самі сорок одну мову, що сайт справді віддає', () => {
