 ...
 * жила прямо в обробнику й рахувалася ВИЩЕ захисту полів вводу — затиснута `R` у
 * полі пошуку витирала всі локальні дані за дві секунди, без запитання. Нижче —
 * рівно ті обмеження, яких там не було.
 */
