...
/**
 * Досвід роботи — ДАНІ. Назва компанії й дати не перекладаються, тож стоять
 * тут; посада й опис приходять зі словника за `roleKey` / `descKey`
 * (`experience.roles`, `experience.descriptions`).
 */
...
} as const satisfies ExperienceData;
