...
>
    ...
    <div class="footer-content">
        ...
        <!--
            Номер версії живе на службовому таблі (`ui/LogCopyButton`), а не тут.
            Закомментований рядок пролежав у підвалі довго — найгірший із трьох
            варіантів: відвідувачеві номер збірки не потрібен, а тому, хто розбирає
            скріншот, його однаково не було видно. Табло показує його в dev завжди, а
            в проді — на вимогу (серія `V`, `?debug=1`).
        -->
    </div>
</footer>
