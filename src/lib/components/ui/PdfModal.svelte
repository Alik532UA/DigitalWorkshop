    ...
    <div class="pdf-options">
        ...
        >
            <div class="pdf-preview">
                <img
                    src="{base}/pdf-preview/Alik-Zapolnov-DigitalWorkshop-ATS-RMS-EN.jpg"
                    alt="ATS / RMS DigitalWorkshop Preview"
                    loading="lazy"
                    decoding="async"
                />
            </div>
        ...
        >
            <div class="pdf-preview">
                <img
                    src="{base}/pdf-preview/Alik-Zapolnov-DigitalWorkshop-dark.jpg"
                    alt="Dark Theme DigitalWorkshop Preview"
                    loading="lazy"
                    decoding="async"
                />
            </div>
        ...
        >
            <div class="pdf-preview">
                <img
                    src="{base}/pdf-preview/Alik-Zapolnov-DigitalWorkshop-light.jpg"
